...
## 0. Define workflow parameters

```{r setup workflow parameters, echo = TRUE}
...
z_ann <- read.delim("~/projects/local/ZebraQ/data/samplesheet.tsv", 
...
# import count matrix
z_counts <- read.delim(
  "~/projects/local/ZebraQ/data/salmon.merged.gene_counts.filtered.tsv", 
  stringsAsFactors=FALSE
  )
...
# print the first 6 rows of the results data frame
head(res)
...
write.table(res, file = "DESeq2_results.tsv",
            sep = "\t", quote = FALSE, row.names = FALSE)

# export results as a excel file
library(openxlsx)
write.xlsx(res, file = "DESeq2_results.xlsx",
           rowNames = FALSE)
