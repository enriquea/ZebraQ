...
| `enrichment/` | Enrichment, ortholog and network results used by S6 and S7, so a failed download never stops the lesson. Regenerate with [`make_enrichment_data.R`](data/enrichment/make_enrichment_data.R) |
...
Day-2 decks, generated by [`slides/make_slides.py`](slides/make_slides.py):
[S6](slides/S6_slides.pptx) · [S7](slides/S7_slides.pptx) · [S8](slides/S8_slides.pptx)
